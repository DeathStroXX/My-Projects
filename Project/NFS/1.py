...
carimg=pygame.image.load('car11.png')
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("NEED FOR SPEED",largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf,textRect=text_objects("This is an car game in which you need dodge the coming cars without crashing.",smalltext)
...
def countdown():
    ...
    while countdown:
            ...
            TextSurf,TextRect=text_objects("DRIVE SAFFE :)",largetext)
            TextRect.center=((display_width/2),(display_height/2))
            gamedisplays.blit(TextSurf,TextRect)
            pygame.display.update()
            clock.tick(1)
...
def score_system(passed,score):
    ...
    gamedisplays.blit(text,(10,60))
    gamedisplays.blit(score,(10,40))
...
def game_loop():
    ...
    obs=0
    y_change=0
    obs_startx=random.randrange(200,(display_width-200))	#this ensures that obstacle car enters in track only	
    obs_starty=-750
    obs_width=56
    obs_height=125
    passed=0
